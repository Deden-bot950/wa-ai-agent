exports.handler = async (event, context) => {
  ...
  try {
    ...
    var cleanOwner  = OWNER_NUMBER.replace(/[^0-9]/g, "");

    // DIUBAH: tidak abaikan pesan dari nomor manapun termasuk owner
    // Hanya abaikan jika pengirim adalah nomor Rifty sendiri (6285371526068)
    var RIFTY_NUMBER = "6285371526068";
    if (cleanSender === RIFTY_NUMBER.replace(/[^0-9]/g, "")) {
